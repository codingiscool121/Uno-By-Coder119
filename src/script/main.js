var UNO = (function(main){
  ...
  self.draw = function(){
    ...
    self.colorChangeDom = js('<div class="colorChange"><p>Choose a color.:</p><div id="colorChangeOp"></div></div>');
  ...
  self.newGame = function(){
    ...
    if(self.PLAYERS.length < 4){console.error("Define the players"); return;}
    self.cardsShuffled = [];
...
var GameOver = (function(main){
  ...
  self.show = function(game, winner, players){
    ...
    var btt = js('<div class="bttNewGame">New Game</div>');
    btt.on('click', function(){
      divMain.removeClass("active");
      setTimeout(function(){
        game.newGame();
...
game.players("You", "Player 2", "Player 3", "Player 4");
