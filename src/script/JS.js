...
(function(win, js){
  ...
  if("object" == typeof module && "object" == typeof module.exports){
    if(module.exports = win.document){
      ...
      module.exports = function(a){
        if(!a.document)throw new Error("Javscript requires a window with a document.");
        return js(a, version);
      }
    }
  }else{
  ...
  lib.parseHTML = function(a){
    if(!a || typeof a !== "string"){return [];}
    var b, c = []; 
    b = lib.parser.parseFromString('<div xmlns="http://www.w3.org/1999/xhtml">'+a+'</div>', "text/xml").firstChild;
  ...
  jsRoot.attr = function(a){
    if(arguments.length == 1){
      if(typeof a == 'string'){return this.getAttribute(a);} 
  ...
  jsRoot.removeAttr = function(a){
    a = a.split(/(\s|\,)+/g);
    for(var i=0; i<a.length; i++){this.removeAttribute(a[i]);}
  }
